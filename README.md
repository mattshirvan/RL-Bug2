...
Visualize a direct path ST from the start S to the goal T.
            ...
            begin
                ...
                if the path is obstructed then
                    begin
                        ...
                        (a) hits the line ST at a point closer to T than P and can move towards T, 
                            in which case the robot follows ST;
